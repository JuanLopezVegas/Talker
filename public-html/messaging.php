	...
	<div class="col-lg-12">
		<form name="formMessaging" action="messaging.ctrl.php" method="post" novalidate>
			...
			<div class="form-group">
				...
				<textarea class="form-control" id="formMessagingContent" name="formMessagingContent" placeholder="Write the message here. Tags are not allowed." onkeyup="jsMessagingValidateTextArea('jsMessagingContent')"></textarea>
			</div>
